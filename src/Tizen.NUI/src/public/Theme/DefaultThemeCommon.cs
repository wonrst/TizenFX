    ...
    internal partial class DefaultThemeCreator
    {
        ...
        public Theme Create()
        {
            ...
            theme.AddStyleWithoutClone("Tizen.NUI.BaseComponents.TextField", new TextFieldStyle()
            {
                ...
                GrabHandleImage = "/home/bowon/tizen/nui/TizenFX/src/Tizen.NUI/res/IoT_handler_center_downW.png",
                SelectionHandleImageLeft = new PropertyMap().Add("filename", new PropertyValue("/home/bowon/tizen/nui/TizenFX/src/Tizen.NUI/res/IoT_handler_downleftW.png")),
                SelectionHandleImageRight = new PropertyMap().Add("filename", new PropertyValue("/home/bowon/tizen/nui/TizenFX/src/Tizen.NUI/res/IoT_handler_downrightW.png")),
            });
