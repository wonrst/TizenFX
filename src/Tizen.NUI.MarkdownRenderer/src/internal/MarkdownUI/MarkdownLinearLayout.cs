...
namespace Tizen.NUI.MarkdownRenderer
{
    ...
    internal class MarkdownLinearLayout : LinearLayout
    {
                                          ...
                                          HeightAndWidthState childState, Orientation orientation)
        {
            ...
            float childrenShare = totalWeightLength * (childWeight / totalWeight);
            ...
            if (horizontal)
            {
                childWidthMeasureSpec = new MeasureSpecification(new LayoutLength(childrenShare - (childLayout.Margin.Start + childLayout.Margin.End)), MeasureSpecification.ModeType.Exactly);
            ...
            else // vertical
            {
                ...
                childHeightMeasureSpec = new MeasureSpecification(new LayoutLength(childrenShare - (childLayout.Margin.Top + childLayout.Margin.Bottom)), MeasureSpecification.ModeType.Exactly);
            }
